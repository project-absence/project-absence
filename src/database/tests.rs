...
mod tests {
    ...
    fn create_database() {
        ...
        let secondary_node = Node::new(Type::Hostname, String::from("go.krypton.ninja"));
    ...
    fn add_node() {
        ...
        let get_node = database
            ...
            .unwrap();
        get_node.add(Type::Hostname, String::from("go.krypton.ninja"));
        get_node.add(Type::Hostname, String::from("status.krypton.ninja"));
    ...
    #[test]
    fn add_node_data() {
        let mut node = Node::new(Type::Hostname, String::from("krypton.ninja"));
